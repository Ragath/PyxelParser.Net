...
public sealed class Document : IDisposable
{
    ...
    public Document(Stream stream)
    {
        ...
        MetaData = new Lazy<PyxelData>(() =>
        {
            ...
            return JsonSerializer.Deserialize<PyxelData>(stream1, new JsonSerializerOptions(JsonSerializerDefaults.Web)
            {
    ...
    /// </summary>
    public void Dispose() => ((IDisposable)ZipArchive).Dispose();
}
